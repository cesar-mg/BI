...
# Funciones ETL
from utils.crear_tablas import crear_tablas, eliminar_tablas
...
with DAG(
    ...
    #eliminar_tablas_db = PostgresOperator(
    #task_id="eliminar_tablas_en_postgres",
    ...
    # Flujo si las tablas ya estan creadas, para limpiarlas previamente.
    # Esto para que no se genere el error de que las llaves ya estan presentes
    # en las bases de datos.
    #preprocesamiento >> eliminar_tablas_db >> crear_tablas_db >> poblar_tablas_dimensiones >> poblar_fact_order
